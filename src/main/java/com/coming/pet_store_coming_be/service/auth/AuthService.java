...
public interface AuthService {
  ...
  public void invalidateAndSaveNewRefreshToken(String id, String refreshToken, String deviceId) throws SQLException; // 리프레시 토큰, 로그인 여부 상태 업데이트 비즈니스 로직 인터페이스 메서드
